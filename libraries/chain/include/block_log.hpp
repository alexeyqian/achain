...
#include "../../protocol/include/block.hpp"

namespace achain{namespace chain{
    ...
    */
    ...
    class block_log{
        ...
        boost::optional<signed_block> read_block_by_num(uint32_t block_num) const;

        //Return offset of block in file, or block_log::npos if it does not exist.
        uint64_t get_block_pos(uint32_t block_num) const;
        signed_block read_head() const;
        const boost::optional<signed_block>& head()const;
