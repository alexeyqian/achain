...
FC_REFLECT_TYPENAME(achain::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME(achain::protocol::authority::key_authority_map)
FC_REFLECT(achain::protocol::authority,(weight_threshold)(account_auths)(key_auths))
FC_REFLECT_ENUM( achain::protocol::authority::classification, (owner)(active)(key)(posting) )
