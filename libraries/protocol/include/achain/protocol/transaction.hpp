#pragma once
#include <achain/protocol/operations.hpp>
#include <achain/protocol/sign_state.hpp>
...
namespace achain { namespace protocol {
    ...
    struct signed_transaction: public transaction{
        ...
        const signature_type& sign(const private_key_type& ey, const chain_id_type& chain_id);
        ...
        void verify_authority(
            ...
            const authority_getter& get_owner,
            const authority_getter& get_posting,
            uint32_t max_recursion = ACHAIN_MAX_SIG_CHECK_DEPTH )const;
    ...
    void verify_authority( const vector<operation>& ops, const flat_set<public_key_type>& sigs,
                          ...
                          const authority_getter& get_owner,
                          const authority_getter& get_posting,
                          uint32_t max_recursion = ACHAIN_MAX_SIG_CHECK_DEPTH,
...
FC_REFLECT( achain::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( achain::protocol::signed_transaction, (achain::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( achain::protocol::annotated_signed_transaction, (achain::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
